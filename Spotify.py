...
barfig = px.bar(artist_popularity, x=artist_popularity['Popularity'], y=artist_popularity['Artist'], title=f'Top 5 Artists in {selected_year}', labels={'Popularity': 'Average Popularity'},orientation='h')
